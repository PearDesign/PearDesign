...
export class Pear extends Component {
  render() {
    return(
      <div className="Pear">
        <svg width="51" height="59" viewBox="0 0 51 59" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M49.6096 13.845C53.5514 27.3025 47.8258 49.7467 33.692 56.878C25.5092 61.0068 5.54555 59.4262 1.60372 45.9687C-2.33811 32.5111 6.59066 20.2339 23.2776 18.5938C38.5778 18.5938 45.6677 0.387426 49.6096 13.845Z" fill="url(#paint0_linear)"/>
